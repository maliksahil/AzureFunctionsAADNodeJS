...
var tenantID = "<tenant-id>"; // GUID
var clientID = "<client-id>"; // GUID
var appIdURI = "<app-id-uri>"; // From the Expose an API section

var tenantName = "<tenant-name>";
var clientSecret = "<client-secret>"; // This is okay only because it's a demo :)
var resourceScope = "<scope>"; // Scope for the next API (i.e. "<resource-api-appIdURI>/openid")
var resourceHost = "localhost"; // Hostname for next API (i.e. "localhost", "app-name.onmicrosoft.com", etc.) 
var resourcePort = "7071"; // For localhost testing
